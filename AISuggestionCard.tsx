...
import { StrategySuggestion, UserSettings, StrategyKey, UserUsage, UserTier, StrategyLogicData } from '../types';
import { ORACLE_CREDITS_COST, USER_TIERS } from '../constants';
...
const AISuggestionCard: React.FC<AISuggestionCardProps> = ({ suggestion, onApply, userUsage, selectedStrategies, strategyLogicData, userSettings }) => {
